...
CREATE TABLE `restaurants` (
  ...
  KEY `idx_restaurants_category` (`category_id`),
...
INSERT INTO `categories` (`id`, `name`, `slug`, `description`, `is_active`, `is_featured`, `sort_order`, `created_at`, `updated_at`) VALUES
...
-- ============================================================================
-- Triggers and stored procedures have been removed for production compatibility.
-- In shared hosting environments, these features often require SUPER privileges
-- that are not available. The application will handle these operations in PHP.
--
-- Removed sections:
