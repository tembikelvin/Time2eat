...
class BaseController{
  ...
  public function __construct(){
    ...
    $this->websiteLogo = wp_get_attachment_image_src( get_theme_mod( 'custom_logo' ) );
    $this->websiteTitle = wp_specialchars_decode( get_bloginfo( 'name' ), ENT_QUOTES );
    ...
    $this->cancelRequestUrl = "$this->dSApi/xp021/v1/request/cancel";
