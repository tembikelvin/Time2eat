...
class UserController extends AdminBaseController
{
    ...
    public function store(): void
    {
        ...
        try {
            ...
            $this->jsonResponse(['success' => false, 'message' => 'An error occurred while creating user'], 500);
        }
    }
    ...
    public function show(int $id): void
    {
        ...
        if (!$user) {
            $this->redirect(url('/admin/users?error=User not found'));
            return;
        }
    ...
    public function updateUser(int $id): void
    {
        ...
        try {
            ...
            $this->jsonResponse(['success' => false, 'message' => 'An error occurred while updating user'], 500);
        }
    }
    ...
    public function destroy(int $id): void
    {
        ...
        try {
            ...
            $this->jsonResponse(['success' => false, 'message' => 'An error occurred while deleting user'], 500);
        }
    }
