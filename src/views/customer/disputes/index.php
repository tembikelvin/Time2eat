...
<div class="tw-max-w-6xl tw-mx-auto tw-p-6">
    ...
    <div class="tw-mb-8">
        <div class="tw-flex tw-items-center tw-justify-between">
            <div>
                <h1 class="tw-text-2xl tw-font-bold tw-text-gray-900">My Disputes</h1>
                <p class="tw-mt-1 tw-text-sm tw-text-gray-600">
                    Track the status of your reported issues
                </p>
            </div>
            <a href="/customer/orders" class="tw-bg-blue-600 tw-text-white tw-rounded-md tw-px-4 tw-py-2 tw-text-sm tw-font-medium hover:tw-bg-blue-700">
    ...
    <?php if (empty($disputes)): ?>
        ...
        <div class="tw-bg-white tw-rounded-lg tw-shadow-sm tw-border tw-border-gray-200 tw-p-12 tw-text-center">
            ...
            <p class="tw-text-gray-600 tw-mb-6">
                You haven't reported any issues with your orders yet.
            </p>
            <a href="/customer/orders" class="tw-bg-blue-600 tw-text-white tw-rounded-md tw-px-4 tw-py-2 tw-text-sm tw-font-medium hover:tw-bg-blue-700">
                View Your Orders
            </a>
                            ...
                            <tr class="hover:tw-bg-gray-50">
                                <td class="tw-px-6 tw-py-4">
                                    <div>
                                        ...
                                        <?php if (!empty($dispute['restaurant_name'])): ?>
                                            <div class="tw-text-xs tw-text-gray-500 tw-mt-1">
                                                <?= e($dispute['restaurant_name']) ?>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </td>
...
function displayDisputeDetails(dispute) {
    ...
    content.innerHTML = `
        <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-6">
            <div>
                ...
                <div class="tw-space-y-2 tw-text-sm">
                    ...
                    <div><span class="tw-text-gray-600">Restaurant:</span> ${dispute.restaurant_name || 'N/A'}</div>
        ...
        ${dispute.compensation_amount && dispute.compensation_amount > 0 ? `
            <div>
                <h4 class="tw-font-medium tw-text-gray-900 tw-mb-2">Compensation</h4>
                <div class="tw-bg-blue-50 tw-rounded-lg tw-p-4">
                    <p class="tw-text-sm tw-text-gray-700">
                        Compensation Amount: <span class="tw-font-medium">${Number(dispute.compensation_amount).toLocaleString()} XAF</span>
                    </p>
                </div>
            </div>
        ` : ''}
